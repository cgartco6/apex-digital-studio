...
const userSchema = new mongoose.Schema({
  ...
  role: { type: String, enum: ['client', 'designer', 'admin', 'agent', 'vendor', 'creator'], default: 'client' },
  avatar: { url: String, publicId: String },
  company: { name: String, website: String, industry: String },
  billingAddress: { street: String, city: String, state: String, country: String, postalCode: String, phone: String },
  ...
  subscription: {
    ...
    status: { type: String, enum: ['active', 'canceled', 'expired', 'trial'], default: 'trial' },
  ...
  creatorProfile: {
    ...
    creatorType: [{ type: String, enum: ['course', 'document', 'pdf', 'zip', 'design', 'template'] }],
  ...
  // Vendor-specific fields (linked to Vendor model)
...
userSchema.methods.generateAuthToken = function() {
  return jwt.sign({ userId: this._id, role: this.role }, process.env.JWT_SECRET, { expiresIn: process.env.JWT_EXPIRES_IN });
};
